...
//classe das Excecoes
require_once APP . 'Vendor' . DS . 'libs' . DS . 'Common' . DS . 'ExceptionNFePHP.class.php';
//classe extendida da classe FPDF para montagem do arquivo pdf
require_once APP . 'Vendor' . DS . 'libs' . DS . 'Common' . DS . 'PdfNFePHP.class.php';
...
require_once APP . 'Vendor' . DS . 'libs' . DS . 'Common' . DS . 'DomDocumentNFePHP.class.php';
...
//            }
     ...
     * @author Edson Lima
     * TODO se fo TRUE é (NFC-e) se for false é (NFE)
     */
    public function checkNFCE()
    {        //valida se o XML é uma NF-e modelo 55, pois não pode ser 65 (NFC-e)
        return ($this->pSimpleGetValue($this->ide, "mod") != '55') ? true : false;
    }
