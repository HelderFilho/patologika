...
App::import('Controller', 'Macros');
App::import('Controller', 'Histologia1s');
 ...
 */
    ...
    public function returnMacro(){
                return $this->PreConf->find('all', array(
                    'conditions'=> array( 'OR'=>array('PreConf.Destino'=>'Macro','PreConf.Destino'=>'Ambos' ))));
...
$encoded_data = $foto;
    ...
    $Macro = new MacrosController();
        $Histologia = new Histologia1sController();
		          	...
		          	$this->PreConf->create();
                         ...
                         $this->request->data['PreConf']['Modified'] = $Modified->format('Y-m-d H:i');
                             ...
                             //$f = $this->request->data['Peca']['foto'];
                                $id = $this->PreConf->getLastInsertID();
                                $nome = $this->request->data['PreConf']['Nome_Paciente'];
                                $numero_blocos = $this->request->data['PreConf']['Numero_Blocos'];
                                $numero_frascos = $this->request->data['PreConf']['Numero_Frascos'];
                                $tipo = $this->request->data['PreConf']['Tipo'];
                               
                                if ($this->request->data['PreConf']['Destino']=='Macroscopia'||$this->request->data['PreConf']['Destino']=='Ambos'){
                                    $Macro->salvar($id, $nome, $tipo, $numero_blocos, $numero_frascos);
                                }else if ($this->request->data['PreConf']['Destino']=='Histologia'||$this->request->data['PreConf']['Destino']=='Ambos'){
                                    $Histologia->salvar($id, $nome, $tipo, $numero_blocos, $numero_frascos);
