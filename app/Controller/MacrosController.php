...
public function salvar($Id, $Nome, $Tipo, $QuantidadeBlocos, $QuantidadeLaminas){
		...
		$this->request->data['Macro']['Id'] = $Id;
		$this->request->data['Macro']['Nome_Paciente'] = $Nome;		
		$this->request->data['Macro']['Tipo'] = $Tipo;		
		$this->request->data['Macro']['Numero_Blocos'] = $QuantidadeBlocos;		
		$this->request->data['Macro']['Numero_Laminas'] = $Quantidade_Laminas;
		$this->request->data['Macro']['Descartado'] = 'N';
		$this->request->data['Macro']['Removed'] = 'N';
		$this->Macro->save($this->request->data);
	}
