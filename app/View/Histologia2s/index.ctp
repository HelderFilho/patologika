<section class="content-header">
    <h1>
        <?php echo __('Histologia 2'); ?>
        <small><?php echo __('All Registered'); ?></small>
    </h1>
    <?php  $this->Html->addCrumb(__(' Home'), '/',['i','class'=>'fa fa-dashboard']);
            $this->Html->addCrumb(__('Histologia 2'));
                ...
                <table  class="table table-striped table-bordered table-hover" id="dataTables-example">
					...
					<td><?php echo $this->Html->div('row',$this->Form->input('Etiquetagem',array('div'=>'col-xs-12','style'=>'width:100%','label'=>'','data-toggle'=>'tooltip','data-original-title'=>__('Etiquetagem'),'title'=>__('Etiquetagem'),'class'=>'form-control input-sm')),array('escape'=>false));?></td>
		              <td><?php echo $this->Form->submit(__('Search'),array('class' => 'btn btn-primary','data-toggle'=>'tooltip','data-original-title'=>__('Search'),'title'=>__('Search'))) ?></td>
                        ...
                        <td><?php echo h($histologia2['Histologia2']['Nome_Paciente']); ?>&nbsp;</td>
                        <td><?php echo h($histologia2['Histologia2']['Tipo']); ?>&nbsp;</td>
								...
								<div class="pull-right">
									<div class="btn-group">
										...
										<ul class="dropdown-menu pull-right" role="menu">
								            <li><?php echo $this->Html->link($this->Html->tag('b', __(' View'), array('class' => 'btn btn-primary','escape' => false)), $this->Html->url(array('action' => 'view', $histologia2['Histologia2']['Id'])), array('escape' => false)); ?></li>                                            
                                            <li><?php echo $this->Html->link($this->Html->tag('b', __(' Realizar Histologia 2'), array('class' => 'btn btn-primary','escape' => false)), $this->Html->url(array('action' => 'edit', $histologia2['Histologia2']['Id'])), array('escape' => false)); ?></li>
