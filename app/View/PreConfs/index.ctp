...
<div class="preconfs index" style="margin: 20px" >
        ...
        <div class="table-responsive">
            <div id="dataTables-example_wrapper" class="dataTables_wrapper form-inline" role="grid" style="margin: 20px">                 
                <table  class="table table-striped table-bordered table-hover" id="dataTables-example">
                    ...
                    <tbody>
                        <tr>
                            <?php $base_url = array('controller' => 'PreConfs', 'action' => 'index');?>
                     ...
                     <td><?php echo $this->Html->div('row',$this->Form->input('Numero_Blocos',array('div'=>'col-xs-12','style'=>'width:100%','label'=>'','data-toggle'=>'tooltip','data-original-title'=>__('Número de blocos'),'title'=>__('Numero de blocos'),'class'=>'form-control input-sm')),array('escape'=>false));?></td>
                       ...
                       <td><?php echo $this->Form->submit(__('Search'),array('class' => 'btn btn-primary','data-toggle'=>'tooltip','data-original-title'=>__('Search'),'title'=>__('Search'))) ?></td>
                        ...
                        <?php foreach ($preConfs as $preConf): ?>
                        <tr>
                            ...
                            <?php if ($preConf['PreConf']['Descartado']=='S'){?>
                        <td class="Encerrado"><?php echo h($preConf['PreConf']['Responsavel']); ?>&nbsp;</td>
                            <?php } else if ($preConf['PreConf']['Descartado']=='N' && $preConf['PreConf']['Created'] < $DataTempo){ ?> 
                        <td class="ParaDescartar"><?php echo h($preConf['PreConf']['Responsavel']); ?>&nbsp;</td>
                            <?php } else { ?>
                        <td class="Andamento"><?php echo h($preConf['PreConf']['Responsavel']); ?>&nbsp;</td>                        
                          <?php } ?>

                       
                            <?php if ($preConf['PreConf']['Descartado']=='S'){?>
                        <td class="Encerrado"><?php echo h($preConf['PreConf']['Data_Descarte']); ?>&nbsp;</td>
                            <?php } else if ($preConf['PreConf']['Descartado']=='N' && $preConf['PreConf']['Created'] < $DataTempo){ ?> 
                        <td class="ParaDescartar"><?php echo h($preConf['PreConf']['Data_Descarte']); ?>&nbsp;</td>
                            <?php } else { ?>
                        <td class="Andamento"><?php echo h($preConf['Peca']['Data_Descarte']); ?>&nbsp;</td>                        
                          <?php } ?>


                             <?php if ($preConf['PreConf']['Descartado']=='S'){?>
                        <td class="Encerrado"><?php echo h($preConf['PreConf']['Numero_Frascos']); ?>&nbsp;</td>
                            <?php } else if ($preConf['PreConf']['Descartado']=='N' && $preConf['PreConf']['Created']<$DataTempo){ ?> 
                        <td class="ParaDescartar"><?php echo h($preConf['PreConf']['Numero_Frascos']); ?>&nbsp;</td>
                            <?php } else { ?>
                        <td class="Andamento"><?php echo h($preConf['PreConf']['Numero_Frascos']); ?>&nbsp;</td>                        
                          <?php } ?>

                
                            <?php if ($preConf['Peca']['Descartado']=='S'){?>
                        <td class="Encerrado"><?php echo h($preConf['Peca']['Tipo']); ?>&nbsp;</td>
                            <?php } else if ($preConf['Peca']['Descartado']=='N' && $preConf['Peca']['Created']<$DataTempo){ ?> 
                        <td class="ParaDescartar"><?php echo h($preConf['Peca']['Tipo']); ?>&nbsp;</td>
                            <?php } else { ?>
                        <td class="Andamento"><?php echo h($preConf['Peca']['Tipo']); ?>&nbsp;</td>                        
                          <?php } ?>


                            <?php if ($preConf['PreConf']['Descartado']=='S'){?>
                        <td class="Encerrado"><?php echo h($preConf['PreConf']['Complexidade']); ?>&nbsp;</td>
                            <?php } else if ($preConf['PreConf']['Descartado']=='N' && $preConf['PreConf']['Created']<$DataTempo){ ?> 
                        <td class="ParaDescartar"><?php echo h($preConf['PreConf']['Complexidade']); ?>&nbsp;</td>
                            <?php } else { ?>
                        <td class="Andamento"><?php echo h($preConf['PreConf']['Complexidade']); ?>&nbsp;</td>                        
                          <?php } ?>



                            <?php if ($preConf['PreConf']['Descartado']=='S'){?>
                        <td class="Encerrado"><?php echo h($preConf['PreConf']['Numero_Blocos']); ?>&nbsp;</td>
                            <?php } else if ($preConf['PreConf']['Descartado']=='N' && $preConf['PreConf']['Created']<$DataTempo){ ?> 
                        <td class="ParaDescartar"><?php echo h($preConf['PreConf']['Numero_Blocos']); ?>&nbsp;</td>
                            <?php } else { ?>
                        <td class="Andamento"><?php echo h($preConf['PreConf']['Numero_Blocos']); ?>&nbsp;</td>                        
                          <?php } ?>


                           <?php if ($preConf['Peca']['Descartado']=='S'){?>
                        <td class="Encerrado"><?php echo h($preConf['Peca']['Conforme']); ?>&nbsp;</td>
                            <?php } else if ($preConf['Peca']['Descartado']=='N' && $preConf['Peca']['Created']<$DataTempo){ ?> 
                        <td class="ParaDescartar"><?php echo h($preConf['Peca']['Conforme']); ?>&nbsp;</td>
                            <?php } else { ?>
                        <td class="Andamento"><?php echo h($preConf['Peca']['Conforme']); ?>&nbsp;</td>                        
                          <?php } ?>
                                ...
                                <div class="pull-right">
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu pull-right" role="menu">
                                            <li><?php echo $this->Html->link($this->Html->tag('i', __(' View'), array('class' => 'fa fa-eye fa-fw'), array('class' => 'btn btn-primary','escape' => false)), $this->Html->url(array('action' => 'view', $preConf['PreConf']['Id'])), array('escape' => false)); ?></li>
                                            <li><?php echo $this->Html->link($this->Html->tag('i', __(' Edit'), array('class' => 'fa fa-edit fa-fw'), array('class' => 'btn btn-primary','escape' => false)), $this->Html->url(array('action' => 'edit', $preConf['PreConf']['Id'])), array('escape' => false)); ?></li>
                                            <li><?php echo $this->Form->postLink($this->Html->tag('i', __(' Delete'), array('class' => 'fa fa-trash-o fa-fw')), array('action' => 'delete', $preConf['PreConf']['Id']),array('escape'=>false),__('Are you sure you want to delete the %s?', $preConf['PreConf']['Id']),array('class' => 'btn btn-mini'));?> </li>
                                          <li><?php echo $this->Form->postLink($this->Html->tag('i', __(' Descartar'), array('class' => 'fa fa-check' )), array('action' => 'descartar', $preConf['PreConf']['Id']),array('escape'=>false),__('Você tem certeza que quer descartar a peca?'),array('class' => 'btn btn-mini'));?> </li>
                                       </ul>
                                    </div>
                                </div>
                            </td>
