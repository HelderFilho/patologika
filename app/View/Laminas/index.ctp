<section class="content-header">
    ...
    <?php  $this->Html->addCrumb(__(' Home'), '/',['i','class'=>'fa fa-dashboard']);
            $this->Html->addCrumb(__('Laminas'));
            echo $this->Html->getCrumbList(['class'=>'breadcrumb','lastClass'=>'active']);?>
    
</section>
<div class="laminas index" style="margin: 20px" >
        ...
        <div class="table-responsive">
            <div id="dataTables-example_wrapper" class="dataTables_wrapper form-inline" role="grid" style="margin: 20px">                 
                <table  class="table table-striped table-bordered table-hover" id="dataTables-example">
                	<thead>
                	   <tr>
                            <th><?php echo $this->Paginator->sort('Responsavel',__('Responsável'),array('data-toggle'=>'tooltip','data-original-title'=>__('Responsavel'),'title'=>__('Responsavel'))); ?></th>
                            <th><?php echo $this->Paginator->sort('Date',__('Data de criação'),array('data-toggle'=>'tooltip','data-original-title'=>__('Date'),'title'=>__('Date'))); ?></th>
                            <th><?php echo $this->Paginator->sort('Numero_Laminas',__('Número de lâminas'),array('data-toggle'=>'tooltip','data-original-title'=>__('Numero_Laminas'),'title'=>__('Numero_Laminas'))); ?></th>
                            <th><?php echo $this->Paginator->sort('Numero_Frascos',__('Número de frascos'),array('data-toggle'=>'tooltip','data-original-title'=>__('Numero_Frascos'),'title'=>__('Numero_Frascos'))); ?></th>
                 ...
                 <!--           <th><?php echo $this->Paginator->sort('Motivos_Conformidade',__('Motivos_Conformidade'),array('data-toggle'=>'tooltip','data-original-title'=>__('Motivos_Conformidade'),'title'=>__('Motivos_Conformidade'))); ?></th>
                 ...
                 -->
                	...
                	<tbody>
                	    <tr>
                    	    <?php $base_url = array('controller' => 'Laminas', 'action' => 'index');?>
                    	    <?php echo $this->Form->create("Filter",array('url' => $base_url, 'class' => 'filter'));?>
					 <td><?php echo $this->Html->div('row',$this->Form->input('Responsavel',array('div'=>'col-xs-12','style'=>'width:100%','label'=>'','data-toggle'=>'tooltip','data-original-title'=>__('Responsavel'),'title'=>__('Responsável'),'class'=>'form-control input-sm')),array('escape'=>false));?></td>
					 ...
					 <td><?php echo $this->Html->div('row',$this->Form->input('Numero_Laminas',array('div'=>'col-xs-12','style'=>'width:100%','label'=>'','data-toggle'=>'tooltip','data-original-title'=>__('Numero_Lâminas'),'title'=>__('Numero de lâminas'),'class'=>'form-control input-sm')),array('escape'=>false));?></td>
				     <td><?php echo $this->Html->div('row',$this->Form->input('Numero_Frascos',array('div'=>'col-xs-12','style'=>'width:100%','label'=>'','data-toggle'=>'tooltip','data-original-title'=>__('Numero_Frascos'),'title'=>__('Numero de frascos'),'class'=>'form-control input-sm')),array('escape'=>false));?></td>
                    ...
                    <!-- <td><?php echo $this->Html->div('row',$this->Form->input('Motivos_Conformidade',array('div'=>'col-xs-12','style'=>'width:100%','label'=>'','data-toggle'=>'tooltip','data-original-title'=>__('Motivos_Conformidade'),'title'=>__('Motivos_Conformidade'),'class'=>'form-control input-sm')),array('escape'=>false));?></td>
                   ...
                   <td><?php echo $this->Form->submit(__('Search'),array('class' => 'btn btn-primary','data-toggle'=>'tooltip','data-original-title'=>__('Search'),'title'=>__('Search'))) ?></td>
						...
						<tr>
						<td><?php echo h($lamina['Lamina']['Responsavel']); ?>&nbsp;</td>
						<td><?php echo h($lamina['Lamina']['Date']); ?>&nbsp;</td>
						<td><?php echo h($lamina['Lamina']['Numero_Laminas']); ?>&nbsp;</td>
						<td><?php echo h($lamina['Lamina']['Numero_Frascos']); ?>&nbsp;</td>

                        <td><?php echo h($lamina['Lamina']['Conforme']); ?>&nbsp;</td>
					
                 <!--s   	<td><?php echo h($lamina['Lamina']['Motivos_Conformidade']); ?>&nbsp;</td>
						<td><?php echo h($lamina['Lamina']['Falha_Identificacao']); ?>&nbsp;</td>
						<td><?php echo h($lamina['Lamina']['Pagamento']); ?>&nbsp;</td>
						<td><?php echo h($lamina['Lamina']['Material_Trocado']); ?>&nbsp;</td>
						<td><?php echo h($lamina['Lamina']['Material_Ausente']); ?>&nbsp;</td>
								...
								<div class="pull-right">
									<div class="btn-group">
										...
										<ul class="dropdown-menu pull-right" role="menu">
											<li><?php echo $this->Html->link($this->Html->tag('i', __(' View'), array('class' => 'fa fa-eye fa-fw'), array('class' => 'btn btn-primary','escape' => false)), $this->Html->url(array('action' => 'view', $lamina['Lamina']['Id'])), array('escape' => false)); ?></li>
											<li><?php echo $this->Html->link($this->Html->tag('i', __(' Edit'), array('class' => 'fa fa-edit fa-fw'), array('class' => 'btn btn-primary','escape' => false)), $this->Html->url(array('action' => 'edit', $lamina['Lamina']['Id'])), array('escape' => false)); ?></li>
											<li><?php echo $this->Form->postLink($this->Html->tag('i', __(' Delete'), array('class' => 'fa fa-trash-o fa-fw')), array('action' => 'delete', $lamina['Lamina']['Id']),array('escape'=>false),__('Are you sure you want to delete the %s?', $lamina['Lamina']['Id']),array('class' => 'btn btn-mini'));?> </li>
										</ul>
									</div>
								</div>
							</td>
