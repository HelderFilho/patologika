<section class="content-header">
    <h1>
        <?php echo __('Groups'); ?>
        <small><?php echo __('Edit').' '.__('Group'); ?></small>
    </h1>
     <?php  $this->Html->addCrumb(__(' Home'), '/',['i','class'=>'fa fa-dashboard']);
            $this->Html->addCrumb(__('Groups'),'/Groups');
              $this->Html->addCrumb(__('Edit Group'));
...
<?php echo $this->Form->create('Group'); ?>
    <fieldset>
        <div class="panel panel-default">
            ...
            <div class="row">
                <div class="div'=>'col-sm-12 col-md-6 col-xs-12">
...
<?php					echo $this->Html->div('row',$this->Form->input('removed',array('value'=>'N','type'=>'hidden','div'=>'col-xs-12','class'=>'form-control input-sm')),array('escape'=>false));
        ...
        <table>
            <tr>
                <td style="padding: 15px" ><button class="btn btn-primary" title='Confirm' data-original-title='Confirm' data-toggle="tooltip" type="submit"><i class="fa fa-check fa-fw"></i> Confirm</button></td>
                <td><a href="echo $this->Html->url(array('action' => 'index'));"><button title='Cancel' data-original-title='Cancel' data-toggle="tooltip" class="btn btn-primary" type="button"><i class="fa fa-close fa-fw"></i>Cancel</button></a></td>
            </tr>
        </table>
	</fieldset>
</div>
