<section class="content-header">
    <h1>
        ...
        <small><?php echo __('Edit').' '.__('Pacient'); ?></small>
    </h1>
     <?php  $this->Html->addCrumb(__(' Home'), '/',['i','class'=>'fa fa-dashboard']);
            $this->Html->addCrumb(__('Pacients'),'/Pacients');
              $this->Html->addCrumb(__('Edit').' '.__('Pacient'));
                ...
                <div class="div'=>'col-sm-12 col-md-7 col-xs-12">
                    <div style="margin: 20px">
					 ...
					 echo $this->Html->div('row',$this->Form->input('Endereco',array('div'=>'col-xs-12','data-toggle'=>'tooltip','data-original-title'=>__('Endereco'),'title'=>__('Endereco'),'class'=>'form-control input-sm')),array('escape'=>false));
							echo $this->Html->div('row',$this->Form->input('Sexo',array('div'=>'col-xs-12','data-toggle'=>'tooltip','data-original-title'=>__('Sexo'),'title'=>__('Sexo'),'class'=>'form-control input-sm', 'options' => array('Masculino'=>'Masculino','Feminino'=>'Feminino'), 'type' => 'radio')));
					...
					echo $this->Html->div('row',$this->Form->hidden('Modified',array('value'=>'','id'=>'Modified','div'=>'col-xs-12 datetimepicker','type'=>'text','data-toggle'=>'tooltip','data-original-title'=>__('Modified'),'title'=>__('Modified'),'class'=>'form-control input-sm')),array('escape'=>false));
				?>
                    </div>
                </div>
            </div>
