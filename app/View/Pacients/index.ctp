        ...
        <div class="table-responsive">
            <div id="dataTables-example_wrapper" class="dataTables_wrapper form-inline" role="grid" style="margin: 20px">                 
                ...
                <!--    	<th><?php echo $this->Paginator->sort('Id',__('Id'),array('data-toggle'=>'tooltip','data-original-title'=>__('Id'),'title'=>__('Id'))); ?></th> -->
                            ...
                            <th><?php echo $this->Paginator->sort('Endereco',__('Endereço'),array('data-toggle'=>'tooltip','data-original-title'=>__('Endereco'),'title'=>__('Endereço'))); ?></th>
                            <th><?php echo $this->Paginator->sort('Sexo',__('Sexo'),array('data-toggle'=>'tooltip','data-original-title'=>__('Sexo'),'title'=>__('Sexo'))); ?></th>
                            <th><?php echo $this->Paginator->sort('Data_Nascimento',__('Data de Nascimento'),array('data-toggle'=>'tooltip','data-original-title'=>__('Data de Nascimento'),'title'=>__('Data de Nascimento'))); ?></th>
                            ...
                            <th><?php echo $this->Paginator->sort('Nome_Responsavel',__('Nome do Responsável'),array('data-toggle'=>'tooltip','data-original-title'=>__('Nome do Responsável'),'title'=>__('Nome do Responsável'))); ?></th>
                            <th><?php echo $this->Paginator->sort('Telefone_Responsavel',__('Telefone do Responsável'),array('data-toggle'=>'tooltip','data-original-title'=>__('Telefone do Responsável'),'title'=>__('Telefone do Responsável'))); ?></th>
                            <th><?php echo $this->Paginator->sort('Informacoes_Extras',__('Informações Extras'),array('data-toggle'=>'tooltip','data-original-title'=>__('Informações Extras'),'title'=>__('Informações Extras'))); ?></th>
