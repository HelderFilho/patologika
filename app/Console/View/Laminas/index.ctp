            ...
            <div id="dataTables-example_wrapper" class="dataTables_wrapper form-inline" role="grid" style="margin: 20px">                 
                <table  class="table table-striped table-bordered table-hover" id="dataTables-example">
                	<thead>
                	   <tr>
                    	<th><?php echo $this->Paginator->sort('Id',__('Id'),array('data-toggle'=>'tooltip','data-original-title'=>__('Id'),'title'=>__('Id'))); ?></th>
                            ...
                            <th><?php echo $this->Paginator->sort('Numero_Lâminas',__('Numero_Lâminas'),array('data-toggle'=>'tooltip','data-original-title'=>__('Numero_Lâminas'),'title'=>__('Numero_Lâminas'))); ?></th>
                	...
                	<tbody>
					 ...
					 <td><?php echo $this->Html->div('row',$this->Form->input('Numero_Lâminas',array('div'=>'col-xs-12','style'=>'width:100%','label'=>'','data-toggle'=>'tooltip','data-original-title'=>__('Numero_Lâminas'),'title'=>__('Numero_Lâminas'),'class'=>'form-control input-sm')),array('escape'=>false));?></td>
...
<td><?php echo $this->Form->submit(__('Search'),array('class' => 'btn btn-primary','data-toggle'=>'tooltip','data-original-title'=>__('Search'),'title'=>__('Search'))) ?></td>
						...
						<tr>
						<td><?php echo h($lamina['Lamina']['Id']); ?>&nbsp;</td>
						<td><?php echo h($lamina['Lamina']['Responsavel']); ?>&nbsp;</td>
						<td><?php echo h($lamina['Lamina']['Date']); ?>&nbsp;</td>
						<td><?php echo h($lamina['Lamina']['Numero_Lâminas']); ?>&nbsp;</td>
						<td><?php echo h($lamina['Lamina']['Conforme']); ?>&nbsp;</td>
						<td><?php echo h($lamina['Lamina']['Motivos_Conformidade']); ?>&nbsp;</td>
						...
						<td><?php echo h($lamina['Lamina']['Removed']); ?>&nbsp;</td>
						<td><?php echo h($lamina['Lamina']['Created']); ?>&nbsp;</td>
						<td><?php echo h($lamina['Lamina']['Modified']); ?>&nbsp;</td>
