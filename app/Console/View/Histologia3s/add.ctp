<section class="content-header">
    <h1>
        ...
        <small><?php echo __('Add').' '.__('Histologia3'); ?></small>
    </h1>
     <?php  $this->Html->addCrumb(__(' Home'), '/',['i','class'=>'fa fa-dashboard']);
            $this->Html->addCrumb(__('Histologia3s'),'/Histologia3s');
              $this->Html->addCrumb(__('Add').' '.__('Histologia3'));
            ...
            <div class="row">
                <div class="div'=>'col-sm-12 col-md-7 col-xs-12">
                    <div style="margin: 20px">
                        <?php
					 echo $this->Html->div('row',$this->Form->input('Inclusaio',array('div'=>'col-xs-12','data-toggle'=>'tooltip','data-original-title'=>__('Inclusaio'),'title'=>__('Inclusaio'),'class'=>'form-control input-sm')),array('escape'=>false));
