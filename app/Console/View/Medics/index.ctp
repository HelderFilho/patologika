<section class="content-header">
    ...
    <?php  $this->Html->addCrumb(__(' Home'), '/',['i','class'=>'fa fa-dashboard']);
            $this->Html->addCrumb(__('Medics'));
            echo $this->Html->getCrumbList(['class'=>'breadcrumb','lastClass'=>'active']);?>
    
</section>
<div class="medics index" style="margin: 20px" >
        ...
        <div class="table-responsive">
            <div id="dataTables-example_wrapper" class="dataTables_wrapper form-inline" role="grid" style="margin: 20px">                 
                <table  class="table table-striped table-bordered table-hover" id="dataTables-example">
                	<thead>
                	   <tr>
                    	<th><?php echo $this->Paginator->sort('Id',__('Id'),array('data-toggle'=>'tooltip','data-original-title'=>__('Id'),'title'=>__('Id'))); ?></th>
                            ...
                            <th><?php echo $this->Paginator->sort('CRM',__('CRM'),array('data-toggle'=>'tooltip','data-original-title'=>__('CRM'),'title'=>__('CRM'))); ?></th>
                            <th><?php echo $this->Paginator->sort('Especializacao',__('Especializacao'),array('data-toggle'=>'tooltip','data-original-title'=>__('Especializacao'),'title'=>__('Especializacao'))); ?></th>
                	...
                	<tbody>
                	    <tr>
                    	    <?php $base_url = array('controller' => 'Medics', 'action' => 'index');?>
					 ...
					 <td><?php echo $this->Html->div('row',$this->Form->input('CRM',array('div'=>'col-xs-12','style'=>'width:100%','label'=>'','data-toggle'=>'tooltip','data-original-title'=>__('CRM'),'title'=>__('CRM'),'class'=>'form-control input-sm')),array('escape'=>false));?></td>
					 <td><?php echo $this->Html->div('row',$this->Form->input('Especializacao',array('div'=>'col-xs-12','style'=>'width:100%','label'=>'','data-toggle'=>'tooltip','data-original-title'=>__('Especializacao'),'title'=>__('Especializacao'),'class'=>'form-control input-sm')),array('escape'=>false));?></td>
...
<td><?php echo $this->Form->submit(__('Search'),array('class' => 'btn btn-primary','data-toggle'=>'tooltip','data-original-title'=>__('Search'),'title'=>__('Search'))) ?></td>
						...
						<td><?php echo h($medic['Medic']['Nome']); ?>&nbsp;</td>
						<td><?php echo h($medic['Medic']['Endereco']); ?>&nbsp;</td>
						<td><?php echo h($medic['Medic']['Telefone']); ?>&nbsp;</td>
						<td><?php echo h($medic['Medic']['Email']); ?>&nbsp;</td>
						<td><?php echo h($medic['Medic']['RG']); ?>&nbsp;</td>
						<td><?php echo h($medic['Medic']['CPF']); ?>&nbsp;</td>
						<td><?php echo h($medic['Medic']['CRM']); ?>&nbsp;</td>
						<td><?php echo h($medic['Medic']['Especializacao']); ?>&nbsp;</td>
						<td><?php echo h($medic['Medic']['Removed']); ?>&nbsp;</td>
						<td><?php echo h($medic['Medic']['Created']); ?>&nbsp;</td>
						<td><?php echo h($medic['Medic']['Modified']); ?>&nbsp;</td>
								...
								<div class="pull-right">
									<div class="btn-group">
										...
										<ul class="dropdown-menu pull-right" role="menu">
											<li><?php echo $this->Html->link($this->Html->tag('i', __(' View'), array('class' => 'fa fa-eye fa-fw'), array('class' => 'btn btn-primary','escape' => false)), $this->Html->url(array('action' => 'view', $medic['Medic']['id'])), array('escape' => false)); ?></li>
											<li><?php echo $this->Html->link($this->Html->tag('i', __(' Edit'), array('class' => 'fa fa-edit fa-fw'), array('class' => 'btn btn-primary','escape' => false)), $this->Html->url(array('action' => 'edit', $medic['Medic']['id'])), array('escape' => false)); ?></li>
											<li><?php echo $this->Form->postLink($this->Html->tag('i', __(' Delete'), array('class' => 'fa fa-trash-o fa-fw')), array('action' => 'delete', $medic['Medic']['id']),array('escape'=>false),__('Are you sure you want to delete the %s?', $medic['Medic']['id']),array('class' => 'btn btn-mini'));?> </li>
										</ul>
									</div>
								</div>
							</td>
