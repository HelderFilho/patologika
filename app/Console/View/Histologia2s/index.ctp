<section class="content-header">
    ...
    <?php  $this->Html->addCrumb(__(' Home'), '/',['i','class'=>'fa fa-dashboard']);
            $this->Html->addCrumb(__('Histologia2s'));
            echo $this->Html->getCrumbList(['class'=>'breadcrumb','lastClass'=>'active']);?>
    
</section>
<div class="histologia2s index" style="margin: 20px" >
        ...
        <div class="table-responsive">
            <div id="dataTables-example_wrapper" class="dataTables_wrapper form-inline" role="grid" style="margin: 20px">                 
                <table  class="table table-striped table-bordered table-hover" id="dataTables-example">
                	...
                	<tbody>
                	    <tr>
                    	    <?php $base_url = array('controller' => 'Histologia2s', 'action' => 'index');?>
					 ...
					 <td><?php echo $this->Html->div('row',$this->Form->input('Inclusao',array('div'=>'col-xs-12','style'=>'width:100%','label'=>'','data-toggle'=>'tooltip','data-original-title'=>__('Inclusao'),'title'=>__('Inclusao'),'class'=>'form-control input-sm')),array('escape'=>false));?></td>
...
<td><?php echo $this->Form->submit(__('Search'),array('class' => 'btn btn-primary','data-toggle'=>'tooltip','data-original-title'=>__('Search'),'title'=>__('Search'))) ?></td>
                		...
                		<?php foreach ($histologia2s as $histologia2): ?>
						<tr>
						<td><?php echo h($histologia2['Histologia2']['Id']); ?>&nbsp;</td>
						<td><?php echo h($histologia2['Histologia2']['Inclusao']); ?>&nbsp;</td>
						<td><?php echo h($histologia2['Histologia2']['Corte']); ?>&nbsp;</td>
						<td><?php echo h($histologia2['Histologia2']['Etiquetagem']); ?>&nbsp;</td>
						<td><?php echo h($histologia2['Histologia2']['Created']); ?>&nbsp;</td>
						<td><?php echo h($histologia2['Histologia2']['Modified']); ?>&nbsp;</td>
						<td><?php echo h($histologia2['Histologia2']['Removed']); ?>&nbsp;</td>
								...
								<div class="pull-right">
									<div class="btn-group">
										...
										<ul class="dropdown-menu pull-right" role="menu">
											<li><?php echo $this->Html->link($this->Html->tag('i', __(' View'), array('class' => 'fa fa-eye fa-fw'), array('class' => 'btn btn-primary','escape' => false)), $this->Html->url(array('action' => 'view', $histologia2['Histologia2']['Id'])), array('escape' => false)); ?></li>
											<li><?php echo $this->Html->link($this->Html->tag('i', __(' Edit'), array('class' => 'fa fa-edit fa-fw'), array('class' => 'btn btn-primary','escape' => false)), $this->Html->url(array('action' => 'edit', $histologia2['Histologia2']['Id'])), array('escape' => false)); ?></li>
											<li><?php echo $this->Form->postLink($this->Html->tag('i', __(' Delete'), array('class' => 'fa fa-trash-o fa-fw')), array('action' => 'delete', $histologia2['Histologia2']['Id']),array('escape'=>false),__('Are you sure you want to delete the %s?', $histologia2['Histologia2']['Id']),array('class' => 'btn btn-mini'));?> </li>
										</ul>
									</div>
								</div>
							</td>
