<section class="content-header">
    ...
    <?php  $this->Html->addCrumb(__(' Home'), '/',['i','class'=>'fa fa-dashboard']);
            $this->Html->addCrumb(__('Macros'));
            echo $this->Html->getCrumbList(['class'=>'breadcrumb','lastClass'=>'active']);?>
    
</section>
<div class="macros index" style="margin: 20px" >
        ...
        <div class="table-responsive">
            <div id="dataTables-example_wrapper" class="dataTables_wrapper form-inline" role="grid" style="margin: 20px">                 
                <table  class="table table-striped table-bordered table-hover" id="dataTables-example">
                	<thead>
                	   <tr>
                    	<th><?php echo $this->Paginator->sort('Id',__('Id'),array('data-toggle'=>'tooltip','data-original-title'=>__('Id'),'title'=>__('Id'))); ?></th>
                            ...
                            <th><?php echo $this->Paginator->sort('Forma',__('Forma'),array('data-toggle'=>'tooltip','data-original-title'=>__('Forma'),'title'=>__('Forma'))); ?></th>
                            <th><?php echo $this->Paginator->sort('Cor',__('Cor'),array('data-toggle'=>'tooltip','data-original-title'=>__('Cor'),'title'=>__('Cor'))); ?></th>
                            <th><?php echo $this->Paginator->sort('Consistencia',__('Consistencia'),array('data-toggle'=>'tooltip','data-original-title'=>__('Consistencia'),'title'=>__('Consistencia'))); ?></th>
                            <th><?php echo $this->Paginator->sort('Fragmentos',__('Fragmentos'),array('data-toggle'=>'tooltip','data-original-title'=>__('Fragmentos'),'title'=>__('Fragmentos'))); ?></th>
                            <th><?php echo $this->Paginator->sort('Cassetes',__('Cassetes'),array('data-toggle'=>'tooltip','data-original-title'=>__('Cassetes'),'title'=>__('Cassetes'))); ?></th>
                	...
                	<tbody>
                	    <tr>
                    	    <?php $base_url = array('controller' => 'Macros', 'action' => 'index');?>
					 ...
					 <td><?php echo $this->Html->div('row',$this->Form->input('Forma',array('div'=>'col-xs-12','style'=>'width:100%','label'=>'','data-toggle'=>'tooltip','data-original-title'=>__('Forma'),'title'=>__('Forma'),'class'=>'form-control input-sm')),array('escape'=>false));?></td>
					 <td><?php echo $this->Html->div('row',$this->Form->input('Cor',array('div'=>'col-xs-12','style'=>'width:100%','label'=>'','data-toggle'=>'tooltip','data-original-title'=>__('Cor'),'title'=>__('Cor'),'class'=>'form-control input-sm')),array('escape'=>false));?></td>
					 <td><?php echo $this->Html->div('row',$this->Form->input('Consistencia',array('div'=>'col-xs-12','style'=>'width:100%','label'=>'','data-toggle'=>'tooltip','data-original-title'=>__('Consistencia'),'title'=>__('Consistencia'),'class'=>'form-control input-sm')),array('escape'=>false));?></td>
					 <td><?php echo $this->Html->div('row',$this->Form->input('Fragmentos',array('div'=>'col-xs-12','style'=>'width:100%','label'=>'','data-toggle'=>'tooltip','data-original-title'=>__('Fragmentos'),'title'=>__('Fragmentos'),'class'=>'form-control input-sm')),array('escape'=>false));?></td>
					 <td><?php echo $this->Html->div('row',$this->Form->input('Cassetes',array('div'=>'col-xs-12','style'=>'width:100%','label'=>'','data-toggle'=>'tooltip','data-original-title'=>__('Cassetes'),'title'=>__('Cassetes'),'class'=>'form-control input-sm')),array('escape'=>false));?></td>
...
<td><?php echo $this->Form->submit(__('Search'),array('class' => 'btn btn-primary','data-toggle'=>'tooltip','data-original-title'=>__('Search'),'title'=>__('Search'))) ?></td>
						...
						<tr>
						<td><?php echo h($macro['Macro']['Id']); ?>&nbsp;</td>
						<td><?php echo h($macro['Macro']['Tamanho']); ?>&nbsp;</td>
						<td><?php echo h($macro['Macro']['Forma']); ?>&nbsp;</td>
						<td><?php echo h($macro['Macro']['Cor']); ?>&nbsp;</td>
						<td><?php echo h($macro['Macro']['Consistencia']); ?>&nbsp;</td>
						<td><?php echo h($macro['Macro']['Fragmentos']); ?>&nbsp;</td>
						<td><?php echo h($macro['Macro']['Cassetes']); ?>&nbsp;</td>
						<td><?php echo h($macro['Macro']['Removed']); ?>&nbsp;</td>
						<td><?php echo h($macro['Macro']['Created']); ?>&nbsp;</td>
						<td><?php echo h($macro['Macro']['Modified']); ?>&nbsp;</td>
								...
								<div class="pull-right">
									<div class="btn-group">
										...
										<ul class="dropdown-menu pull-right" role="menu">
											<li><?php echo $this->Html->link($this->Html->tag('i', __(' View'), array('class' => 'fa fa-eye fa-fw'), array('class' => 'btn btn-primary','escape' => false)), $this->Html->url(array('action' => 'view', $macro['Macro']['Id'])), array('escape' => false)); ?></li>
											<li><?php echo $this->Html->link($this->Html->tag('i', __(' Edit'), array('class' => 'fa fa-edit fa-fw'), array('class' => 'btn btn-primary','escape' => false)), $this->Html->url(array('action' => 'edit', $macro['Macro']['Id'])), array('escape' => false)); ?></li>
											<li><?php echo $this->Form->postLink($this->Html->tag('i', __(' Delete'), array('class' => 'fa fa-trash-o fa-fw')), array('action' => 'delete', $macro['Macro']['Id']),array('escape'=>false),__('Are you sure you want to delete the %s?', $macro['Macro']['Id']),array('class' => 'btn btn-mini'));?> </li>
										</ul>
									</div>
								</div>
							</td>
