<section class="content-header">
    ...
    <?php  $this->Html->addCrumb(__(' Home'), '/',['i','class'=>'fa fa-dashboard']);
            $this->Html->addCrumb(__('Pre Confs'));
        ...
        <div class="table-responsive">
            <div id="dataTables-example_wrapper" class="dataTables_wrapper form-inline" role="grid" style="margin: 20px">                 
                <table  class="table table-striped table-bordered table-hover" id="dataTables-example">
                	<thead>
                	   <tr>
                    	<th><?php echo $this->Paginator->sort('Id',__('Id'),array('data-toggle'=>'tooltip','data-original-title'=>__('Id'),'title'=>__('Id'))); ?></th>
                            ...
                            <th><?php echo $this->Paginator->sort('Nome_Paciente',__('Nome_Paciente'),array('data-toggle'=>'tooltip','data-original-title'=>__('Nome_Paciente'),'title'=>__('Nome_Paciente'))); ?></th>
                            ...
                            <th><?php echo $this->Paginator->sort('Data_Descarte',__('Data_Descarte'),array('data-toggle'=>'tooltip','data-original-title'=>__('Data_Descarte'),'title'=>__('Data_Descarte'))); ?></th>
                	...
                	<tbody>
                	    <tr>
                    	    <?php $base_url = array('controller' => 'Pre Confs', 'action' => 'index');?>
					 ...
					 <td><?php echo $this->Html->div('row',$this->Form->input('Nome_Paciente',array('div'=>'col-xs-12','style'=>'width:100%','label'=>'','data-toggle'=>'tooltip','data-original-title'=>__('Nome_Paciente'),'title'=>__('Nome_Paciente'),'class'=>'form-control input-sm')),array('escape'=>false));?></td>
					 ...
					 <td><?php echo $this->Html->div('row',$this->Form->input('Data_Descarte',array('div'=>'col-xs-12','style'=>'width:100%','label'=>'','data-toggle'=>'tooltip','data-original-title'=>__('Data_Descarte'),'title'=>__('Data_Descarte'),'class'=>'form-control input-sm')),array('escape'=>false));?></td>
...
<td><?php echo $this->Form->submit(__('Search'),array('class' => 'btn btn-primary','data-toggle'=>'tooltip','data-original-title'=>__('Search'),'title'=>__('Search'))) ?></td>
						...
						<tr>
						<td><?php echo h($preConf['PreConf']['Id']); ?>&nbsp;</td>
						<td><?php echo h($preConf['PreConf']['Responsavel']); ?>&nbsp;</td>
						<td><?php echo h($preConf['PreConf']['Nome_Paciente']); ?>&nbsp;</td>
						<td><?php echo h($preConf['PreConf']['Tipo']); ?>&nbsp;</td>
						<td><?php echo h($preConf['PreConf']['Numero_Frascos']); ?>&nbsp;</td>
						<td><?php echo h($preConf['PreConf']['Numero_Blocos']); ?>&nbsp;</td>
						<td><?php echo h($preConf['PreConf']['Removed']); ?>&nbsp;</td>
						<td><?php echo h($preConf['PreConf']['Created']); ?>&nbsp;</td>
						<td><?php echo h($preConf['PreConf']['Modified']); ?>&nbsp;</td>
						<td><?php echo h($preConf['PreConf']['Data_Descarte']); ?>&nbsp;</td>
						<td><?php echo h($preConf['PreConf']['Conforme']); ?>&nbsp;</td>
